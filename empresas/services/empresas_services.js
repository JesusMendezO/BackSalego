...
// Actualizar Empresas(PUT) "arreglado y reconfigurado"
async function putEmpresas(nEmpresas, params) {
    try {
        ...
        if (data === null || data.length < 1) {
            return {
                status: 500,
                error: "Problema al actualizar empresas, verifique la informacion.",
                data,
            };
        } else {
            return {
