...
// Actualizar Presupuestos(PUT) "arreglado y reconfigurado"
async function putPresupuestos(nPresupuestos, params) {
    try {
        ...
        if (data === null || data.length < 1) {
            return {
                status: 500,
                error: "Problema al actualizar presupuesto, verifique la informacion.",
                data,
            };
        } else {
            return {
