...
// Actualizar Historial_estados(PUT) "arreglado y reconfigurado"
async function putHistorial_estados(nHistorial_estados, params) {
    try {
        ...
        if (data === null || data.length < 1) {
            return {
                status: 500,
                error: "Problema al actualizar historial estado, verifique la informacion.",
                data,
            };
        } else {
            return {
